...
local theme = lush(function(injected_functions)
  ...
  local black = hsl '#0d0d0d'
  local red = hsl '#ffcfe5'
  local green = hsl '#a7faa9'
  local yellow = hsl '#fcba03'
  local blue = hsl '#1E5D8A'
  local magenta = hsl '#ff5eda'
  local cyan = hsl '#69c6c3'
  local white = hsl '#f8f8f8'
  ...
  return {
    ...
    NormalFloat { fg = white }, -- Normal text in floating windows.
    LineNr { fg = white },

    --
    ColorColumn { fg = blue.lighten(5) }, -- Columns set with 'colorcolumn'
    ...
    CursorLine { bg = blue.rotate(10) }, -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    FloatBorder { fg = white }, -- Border of floating windows.
    ...
    SpecialKey { fg = green }, -- Unprintable characters: text displayed differently from what it really is. But not 'listchars' whitespace. |hl-Whitespace|
    ...
    Visual { fg = blue, bg = white }, -- Visual mode selection
    ...
    Comment { fg = cyan, gui = 'italic' }, -- Any comment
    ...
    --
    DiagnosticError { fg = magenta }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    ...
    IblIndent { fg = ColorColumn.fg },
    IblWhitespace { fg = IblIndent.fg },
    IblScope { fg = yellow },

    TelescopeSelection { fg = yellow },
    TelescopeMatching { fg = yellow, bg = black },
    ...
    sym '@variable.tsx' { fg = green },
    sym '@tag.tsx' { fg = yellow },
    sym '@constructor.tsx' { fg = green },
